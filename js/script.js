...
Object.assign(translations.en, {
  ...
  'portfolio-visual-p2': 'The design system keeps Syne for signature display headings, uses Space Grotesk for longer case titles, and relies on regular IBM Plex Sans for body and UI text. The typographic scale is intentionally restrained. Earlier iterations felt too poster-like, especially on detail pages, so the current system favors calmer headings, readable body copy, and stronger spacing discipline.',
...
Object.assign(translations.zh, {
  ...
  'portfolio-visual-p2': '设计系统保留 Syne 做标志性展示标题，用 Space Grotesk 处理更长的案例标题，并用 regular IBM Plex Sans 承载正文和 UI。字号层级有意保持克制。早期迭代在详情页上过于海报化，所以当前系统更偏向冷静标题、可读正文和更严格的间距纪律。',
