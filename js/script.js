...
Object.assign(translations.en, {
  ...
  'resume-title': 'Resume',
  'resume-intro': 'I am Lin Han hui, an AI SaaS product manager who moved from design into product. I work on 0-1 builds, SEO growth, page redesigns, release testing, low-code tweaks, and frontend collaboration, turning ideas into shipped product changes.',
  'resume-edu': 'Nanjing Institute of Technology · Bachelor',
  'resume-wechat': 'WeChat: l15895838711',
  'resume-location': 'Guangzhou, China',
  'resume-profile-title': 'Profile',
  'resume-profile': 'I work across AI SaaS product flows from requirement breakdown, page design, SEO content, development handoff, and release acceptance. I use AI for competitor research, SEO drafts, and requirement notes, then turn growth ideas into shippable pages and tasks.',
  ...
  'resume-exp-2-li-1': 'Designed company website pages and campaign materials across web, social, and offline display.',
  'resume-exp-2-li-2': 'Joined the 0-1 website build, exploring visual direction, hero layout, and core page modules.',
  'resume-exp-2-li-3': 'Delivered UI designs and sliced assets, then reviewed implementation fidelity and adjusted visual details.',
  'resume-exp-3-title': 'Jiangsu Lidu Technology · UI Designer',
  'resume-exp-3-li-1': 'Designed product interfaces, campaign pages, and promotional pages.',
  'resume-exp-3-li-2': 'Joined early feature discussions and produced page structures, visual directions, and key interaction ideas.',
  'resume-exp-3-li-3': 'Supported operation design while also joining requirement discussions and development review.',
  ...
  'resume-project-1-type': 'AI Try-On / Image / Video',
  ...
  'resume-project-2-title': 'flaq.ai · AI Model/API Content & Free Tool Acquisition',
  'resume-project-2-type': 'AI API / Docs / Free Tools',
  ...
  'resume-project-3-title': 'heydream.im · AI Image / Video / 3D Tool Matrix',
  'resume-project-3-type': 'Image / Video / 3D',
  ...
  'resume-project-4-title': 'musicmaker.im · AI Music Product & Audio Tool Matrix',
  'resume-project-4-type': 'AI Music',
  ...
  'resume-project-4-li-4': 'After launch, monthly page views grew to about 20K, with current page conversion around 3%.',
...
Object.assign(translations.zh, {
  ...
  'resume-wechat': '微信：l15895838711',
  'resume-location': '中国 · 广州',
  'resume-profile-title': '个人简介',
  'resume-profile': '熟悉 AI SaaS 产品从需求拆解、页面设计、SEO 内容、开发交接到版本验收的流程。日常会用 AI 做竞品分析、SEO 文案和需求草稿，也参与部分前端协作，能把增长方案拆成可上线的页面和任务。',
  ...
  'resume-exp-2-li-1': '设计公司官网页面和活动宣传物料，覆盖网页端、社媒图和线下展示内容。',
  'resume-exp-2-li-2': '参与官网从 0 到 1 搭建，完成页面风格探索、首屏布局和核心模块设计。',
  'resume-exp-2-li-3': '独立输出 UI 设计稿和切图资源，跟进开发还原度并调整视觉细节。',
  'resume-exp-3-title': '江苏粒度科技有限公司｜UI 设计师',
  'resume-exp-3-li-1': '负责产品界面、运营活动页和宣传页面设计。',
  'resume-exp-3-li-2': '参与新功能早期讨论，输出页面结构、视觉方向和关键交互方案。',
  'resume-exp-3-li-3': '支持运营物料设计，也参与需求讨论和开发还原检查。',
  ...
  'resume-project-1-type': 'AI 试穿 / 图像 / 视频',
  ...
  'resume-project-2-title': 'flaq.ai｜AI 模型/API 平台内容与免费工具引流',
  'resume-project-2-type': 'AI API / 文档 / 免费工具',
  ...
  'resume-project-3-title': 'heydream.im｜AI 图像 / 视频 / 3D 工具矩阵',
  'resume-project-3-type': '图像 / 视频 / 3D',
  ...
  'resume-project-4-title': 'musicmaker.im｜AI 音乐产品与音频工具矩阵',
  'resume-project-4-type': 'AI 音乐',
  ...
  'resume-project-4-li-4': '项目上线后月浏览量增长至约 20K，当前页面转化率约 3%。',
